    ...
    >
      ...
      <div className="socials-flyout">
        {socials.faceit && <a href={`https://${socials.faceit}`} target="_blank" rel="noopener noreferrer" onClick={e => e.stopPropagation()} aria-label="FACEIT">
          <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor"><path d="M0 0v24h24V0zm12.487 18.424-4.952-4.952 4.952-4.952 1.274 1.275-3.678 3.677 3.678 3.677zm4.03-1.275-3.678-3.677 3.678-3.677 1.275-1.275 4.952 4.952-4.952 4.952z"/></svg>
        </a>}
